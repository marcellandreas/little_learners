...
const CardContent = ({ classNameCard }) => {
  return (
    <section className={`flex flex-col relative ${classNameCard}`}>
      ...
      <section className="flex pt-[50px] lg:pt-[60px] 2xl:pt-20 px-[30px] lg:px-10 pb-[30px] 2xl:px-[50px] lg:pb-10 2xl:pb-[50px] flex-col gap-4 2xl:gap-5 rounded-xl border-2 border-grey-15 bg-white shadow-[4px_4px_0px_1px_#1E1E1E] 2xl:shadow-[6px_6px_0px_2px_#1E1E1E]">
