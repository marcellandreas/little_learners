...
const CardBenefits = ({ id, icon, title, description }) => {
  return (
    <section className="flex relative flex-col items-start self-stretch md:col-span-4 ">
      ...
      <div className="flex pt-[50px] md:px-10 md:pt-[50px] md:pb-10 pb-[30px] pl-[30px] pr-[40px] flex-col gap-4 rounded-xl border-2 border-grey-15 shadow-[4px_4px_0px_1px_#1E1E1E]">
